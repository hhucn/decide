  ...
  (let [budget 10000
    ...
    (assertions
      ...
      => {:winners [{:proposal :schokobrunnen
                     :scores   {:borda 7 :approval 3}}
                    {:proposal :wasserspender
                     :scores   {:borda 4 :approval 2}}]
          :losers  [{:proposal :bällebad
                     :scores   {:borda 5 :approval 2}}]}
      ...
      (b/borda-budget
        ...
        budget costs)
      => {:winners [{:proposal :schokobrunnen
                     :scores   {:borda 8 :approval 4}}
                    {:proposal :wasserspender
                     :scores   {:borda 6 :approval 3}}]
          :losers  [{:proposal :bällebad
                     :scores   {:borda 8 :approval 3}}]}

      "A proposal with no votes can not win"
      (b/borda-budget [[]] 1000 {:a 100})
      => {:winners []
          :losers  [{:proposal :a
                     :scores   {:borda 0 :approval 0}}]})))
