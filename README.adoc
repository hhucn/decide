...
`src/main/decidotron/client.cljs` contains the code to start and refresh
...
application `decidotron.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/decidotron.jar
```
